...
class Continent(models.Model):
    ...
    geom = gismodels.MultiPolygonField(srid=4326, spatial_index=True, null=True)
...
class Country(models.Model):
    code = models.CharField(
        max_length=5, blank=True, null=True, default=models.UUIDField
    )
...
class City(models.Model):
    ...
    name_de = models.CharField(max_length=100, blank=True, null=True, default="")
    name_en = models.CharField(max_length=100, blank=True, null=True, default="")
    name_es = models.CharField(max_length=100, blank=True, null=True, default="")
    name_fr = models.CharField(max_length=100, blank=True, null=True, default="")
    name_pt = models.CharField(max_length=100, blank=True, null=True, default="")
    name_ru = models.CharField(max_length=100, blank=True, null=True, default="")
    name_zh = models.CharField(max_length=100, blank=True, null=True, default="")
...
class Aoi(models.Model):
    ...
    geom = gismodels.PolygonField(srid=4326, spatial_index=True, null=True)
...
class Settings(models.Model):
    can_email_result = models.BooleanField(default=True, null=True, blank=True)
...
class Script(models.Model):
    ...
    parametrization_dialogue = models.TextField(default=None, null=True, blank=True)
