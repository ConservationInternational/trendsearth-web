...
class JobManager(object):
    ...
    refreshed_local_state: bool = False
    refreshed_from_remote: bool = False
    downloaded_job_results: bool = False
    downloaded_available_jobs_results: bool = False
    deleted_job: bool = False
    submitted_remote_job: bool = False
    submitted_local_job: bool = False
    processed_local_job: bool = False
    imported_job: bool = False
