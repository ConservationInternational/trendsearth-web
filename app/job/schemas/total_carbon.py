...
class TotalCarbonSchema(BaseJobSchema, DateRangeSchema):
    ...
    include_soil_carbon = fields.Bool(
        load_default=True,
        metadata={
            "title": "Include soil carbon",
            "description": "Include soil organic carbon in calculations",
        },
    )
    ...
    include_biomass_carbon = fields.Bool(
        load_default=True,
        metadata={
            "title": "Include biomass carbon",
            "description": "Include above and below ground biomass carbon",
        },
    )
    ...
    biomass_data = fields.Str(
        ...
        metadata={
            ...
            "description": "Source dataset for biomass carbon calculations",
        },
    )
